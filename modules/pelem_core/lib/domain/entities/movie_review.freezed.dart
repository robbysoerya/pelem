...
/// @nodoc
class __$$_MovieReviewCopyWithImpl<$Res>
    extends _$MovieReviewCopyWithImpl<$Res, _$_MovieReview>
...
class _$_MovieReview implements _MovieReview {
  ...
  @override
  String toString() {
    return 'MovieReview(author: $author, authorDetails: $authorDetails, content: $content, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, url: $url)';
  }
...
abstract class _MovieReview implements MovieReview {
  const factory _MovieReview(
      ...
      required final String url}) = _$_MovieReview;
