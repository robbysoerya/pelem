...
class _$_TVModel implements _TVModel {
  ...
  @override
  String toString() {
    return 'TVModel(backdropPath: $backdropPath, firstAirDate: $firstAirDate, genreIds: $genreIds, id: $id, name: $name, originCountry: $originCountry, originalLanguage: $originalLanguage, originalName: $originalName, overview: $overview, popularity: $popularity, posterPath: $posterPath, voteAverage: $voteAverage, voteCount: $voteCount)';
  }
...
abstract class _TVModel implements TVModel {
  const factory _TVModel(
      ...
      required final int voteCount}) = _$_TVModel;
